...
if [ "$1" != "" ]; then
    ...
    case "$1" in
        ...
        pod1)
            ...
            ;;
        piat)
            vagrant up leaf01 leaf02 leaf03 leaf04 spine01 spine02 spine03 spine04 server01 server02 server03 server04 server05 server06 server07 server08 server09 server10 service01 service02 super01 super02 super03 super04 exit01 exit02 rtr01 rtr02
            ;;
        full)
            vagrant up
            ;;
